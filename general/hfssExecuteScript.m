...
function hfssExecuteScript(hfssExePath, ScriptFile, iconMode, runAndExit,nowait, BatchSolve)
...
if isempty(BatchSolve)
	...
	BatchSolveStr = ['/BatchSolve /Local' BatchSolve];
end;
