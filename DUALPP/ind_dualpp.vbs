...
oProject.InsertDesign "HFSS","ind_dualpp", "DrivenModal", ""
Set oDesign = oProject.SetActiveDesign("ind_dualpp")
Set oEditor = oDesign.SetActiveEditor("3D Modeler")

oProject.SaveAs "E:\ANTLR4_EM_SIM\output\ind_dualpp;OD;50.0;W;2.0;OPE;5.0;OP2;5.0;LEA;10.0;S;2.0;NT;2.hfss", true
...
Sub rfvlsiHFSS_Create_ind_dualpp(rfvlsi_pcellOffsetX0, rfvlsi_pcellOffsetY0, rfvlsi_pcellOffsetORIENT, ByVal OD , ByVal W , ByVal OPENING , ByVal OP2 , ByVal LEAD , ByVal S , ByVal NT , ByVal strName , ByVal NT_N )
	P = (W)+(S)
	DUMMYL = "RFVLSI"
	' dbCreateLabel is skipped in translation output, and not processed at all.
	' dbCreateLabel is skipped in translation output, and not processed at all.
	...
	' Not using MetalVec/ViaVec, thus ignored in translation
	' Not using MetalVec/ViaVec, thus ignored in translation
	rfvlsiHFSS_Create_base_lead_pair rfvlsi_newOriginX(rfvlsi_pcellOffsetX0, rfvlsi_pcellOffsetY0, rfvlsi_pcellOffsetORIENT, 0, (4.0)+(W), rfvlsi_ORIENT_R90), _
		rfvlsi_newOriginY(rfvlsi_pcellOffsetX0, rfvlsi_pcellOffsetY0, rfvlsi_pcellOffsetORIENT, 0, (4.0)+(W), rfvlsi_ORIENT_R90), _	
		rfvlsi_newORIENT(rfvlsi_pcellOffsetORIENT, rfvlsi_ORIENT_R90),_
		W, OPENING, ((((LEAD)+((OD)/(2)))-(4.0))-(W)), "9", "9", True, "N1", "N2"
	rfvlsiHFSS_Create_base_lead_pair rfvlsi_newOriginX(rfvlsi_pcellOffsetX0, rfvlsi_pcellOffsetY0, rfvlsi_pcellOffsetORIENT, 0, ((-(4.0)))-(W), rfvlsi_ORIENT_MYR90), _
		...
		W, OPENING, ((((LEAD)+((OD)/(2)))-(4.0))-(W)), "9", "9", True, "P1", "P2"
	rfvlsiHFSS_Create_base_em_gr rfvlsi_newOriginX(rfvlsi_pcellOffsetX0, rfvlsi_pcellOffsetY0, rfvlsi_pcellOffsetORIENT, 0, 0, rfvlsi_ORIENT_R0), _
		rfvlsi_newOriginY(rfvlsi_pcellOffsetX0, rfvlsi_pcellOffsetY0, rfvlsi_pcellOffsetORIENT, 0, 0, rfvlsi_ORIENT_R0), _	
		rfvlsi_newORIENT(rfvlsi_pcellOffsetORIENT, rfvlsi_ORIENT_R0),_
		(((((2)*(OD))+((2)*(LEAD)))+((2)*(OP2)))+((2)*(OPENING))), (((OD)+((2)*(LEAD)))-(4.0)), 2.0, 10.0, 2
	'Adding a vertical lumped port.
	CVport "N1",(((-(OPENING)))-(W)),(((OD)/(2))+(LEAD)),((-(OPENING))),(((OD)/(2))+(LEAD)),(((-(OPENING))))-((((-(OPENING)))-(W))),"Y",0,8,2
	'Adding a vertical lumped port.
	CVport "N2",OPENING,(((OD)/(2))+(LEAD)),((OPENING)+(W)),(((OD)/(2))+(LEAD)),(((OPENING)+(W)))-(OPENING),"Y",0,8,2
	'Adding a vertical lumped port.
	CVport "P1",(((-(OPENING)))-(W)),((((-(OD)))/(2))-(LEAD)),((-(OPENING))),((((-(OD)))/(2))-(LEAD)),(((-(OPENING))))-((((-(OPENING)))-(W))),"Y",0,8,2
	'Adding a vertical lumped port.
	CVport "P2",OPENING,((((-(OD)))/(2))-(LEAD)),((OPENING)+(W)),((((-(OD)))/(2))-(LEAD)),(((OPENING)+(W)))-(OPENING),"Y",0,8,2
End Sub
'Generating topcell
rfvlsiHFSS_Create_ind_dualpp 0.0, 0.0, rfvlsi_ORIENT_R0, 50.0, 2.0, 5.0, 5.0, 10.0, 2.0, 2, "ind_dualpp", False 
