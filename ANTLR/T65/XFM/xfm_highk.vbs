...
oDesktop.OpenProject "F:\Dropbox\ANTLR\HFSS_API\examples\DIRNAME\nominal.hfss"
		...
		If ((S<=(2.0)*(sqrt(2)))) Then
			CMetalPolygon ((MET-1)), _
				...
				Array(_
					...
					rfvlsi_newOriginX(rfvlsi_PCellOffsetX0, rfvlsi_PCellOffsetY0, rfvlsi_PCellOffsetORIENT, (0), ((-((OOCH+roundtogrid(((2)*(sqrt(2.0))-S)))+0.01))), rfvlsi_ORIENT_R0),_
					rfvlsi_newOriginX(rfvlsi_PCellOffsetX0, rfvlsi_PCellOffsetY0, rfvlsi_PCellOffsetORIENT, (W), ((-((OOCH+roundtogrid(((2)*(sqrt(2.0))-S)))+0.01))), rfvlsi_ORIENT_R0),_
					...
					rfvlsi_newOriginX(rfvlsi_PCellOffsetX0, rfvlsi_PCellOffsetY0, rfvlsi_PCellOffsetORIENT, (OO), (((OOCH+roundtogrid(((2)*(sqrt(2.0))-S)))+0.01)), rfvlsi_ORIENT_R0),_
					rfvlsi_newOriginX(rfvlsi_PCellOffsetX0, rfvlsi_PCellOffsetY0, rfvlsi_PCellOffsetORIENT, ((OO-W)), (((OOCH+roundtogrid(((2)*(sqrt(2.0))-S)))+0.01)), rfvlsi_ORIENT_R0),_
				...
				Array(_
					...
					rfvlsi_newOriginY(rfvlsi_PCellOffsetX0, rfvlsi_PCellOffsetY0, rfvlsi_PCellOffsetORIENT, (0), ((-((OOCH+roundtogrid(((2)*(sqrt(2.0))-S)))+0.01))), rfvlsi_ORIENT_R0),_
					rfvlsi_newOriginY(rfvlsi_PCellOffsetX0, rfvlsi_PCellOffsetY0, rfvlsi_PCellOffsetORIENT, (W), ((-((OOCH+roundtogrid(((2)*(sqrt(2.0))-S)))+0.01))), rfvlsi_ORIENT_R0),_
					...
					rfvlsi_newOriginY(rfvlsi_PCellOffsetX0, rfvlsi_PCellOffsetY0, rfvlsi_PCellOffsetORIENT, (OO), (((OOCH+roundtogrid(((2)*(sqrt(2.0))-S)))+0.01)), rfvlsi_ORIENT_R0),_
					rfvlsi_newOriginY(rfvlsi_PCellOffsetX0, rfvlsi_PCellOffsetY0, rfvlsi_PCellOffsetORIENT, ((OO-W)), (((OOCH+roundtogrid(((2)*(sqrt(2.0))-S)))+0.01)), rfvlsi_ORIENT_R0),_
		...
		Else
			CMetalPolygon ((MET-1)), _
				...
				Array(_
					...
					rfvlsi_newOriginX(rfvlsi_PCellOffsetX0, rfvlsi_PCellOffsetY0, rfvlsi_PCellOffsetORIENT, (W), ((-OOCH)), rfvlsi_ORIENT_R0),_
					rfvlsi_newOriginX(rfvlsi_PCellOffsetX0, rfvlsi_PCellOffsetY0, rfvlsi_PCellOffsetORIENT, ((W+P)), (((-OOCH)+P)), rfvlsi_ORIENT_R0),_
					rfvlsi_newOriginX(rfvlsi_PCellOffsetX0, rfvlsi_PCellOffsetY0, rfvlsi_PCellOffsetORIENT, (OO), ((((-OOCH)+C)+P)), rfvlsi_ORIENT_R0),_
					rfvlsi_newOriginX(rfvlsi_PCellOffsetX0, rfvlsi_PCellOffsetY0, rfvlsi_PCellOffsetORIENT, (P), ((((-OOCH)+C)+P)), rfvlsi_ORIENT_R0),_
					rfvlsi_newOriginX(rfvlsi_PCellOffsetX0, rfvlsi_PCellOffsetY0, rfvlsi_PCellOffsetORIENT, (0), (((-OOCH)+C)), rfvlsi_ORIENT_R0)), _
				Array(_
					rfvlsi_newOriginY(rfvlsi_PCellOffsetX0, rfvlsi_PCellOffsetY0, rfvlsi_PCellOffsetORIENT, (0), (((-OOCH)+C)), rfvlsi_ORIENT_R0),_
					...
					rfvlsi_newOriginY(rfvlsi_PCellOffsetX0, rfvlsi_PCellOffsetY0, rfvlsi_PCellOffsetORIENT, (W), ((-OOCH)), rfvlsi_ORIENT_R0),_
					rfvlsi_newOriginY(rfvlsi_PCellOffsetX0, rfvlsi_PCellOffsetY0, rfvlsi_PCellOffsetORIENT, ((W+P)), (((-OOCH)+P)), rfvlsi_ORIENT_R0),_
					rfvlsi_newOriginY(rfvlsi_PCellOffsetX0, rfvlsi_PCellOffsetY0, rfvlsi_PCellOffsetORIENT, (OO), ((((-OOCH)+C)+P)), rfvlsi_ORIENT_R0),_
					rfvlsi_newOriginY(rfvlsi_PCellOffsetX0, rfvlsi_PCellOffsetY0, rfvlsi_PCellOffsetORIENT, (P), ((((-OOCH)+C)+P)), rfvlsi_ORIENT_R0),_
					rfvlsi_newOriginY(rfvlsi_PCellOffsetX0, rfvlsi_PCellOffsetY0, rfvlsi_PCellOffsetORIENT, (0), (((-OOCH)+C)), rfvlsi_ORIENT_R0)) 
		End If
...
Sub rfvlsiHFSS_Create_xfm_cross(rfvlsi_pcellOffsetX0, rfvlsi_pcellOffsetY0, rfvlsi_pcellOffsetORIENT, WI , WO , S , TOP_ME , BTM_ME , dummy , viat , viad , top )
	' content of let-statement	
		...
		If ((((2)*(S)+WI)<=(2.0)*(sqrt(2.0)))) Then
			OOCHD = (roundtogrid(((2.0)*(sqrt(2.0))-WI))+0.01)
		Else
			OOCHD = 0.0
		End If
...
Sub rfvlsiHFSS_Create_xfm_highk(rfvlsi_pcellOffsetX0, rfvlsi_pcellOffsetY0, rfvlsi_pcellOffsetORIENT, OD , WI , WO , ROP , LEAD , LEADDYI , LEADDYO , S , en_dmy , en_NTN , balun_str )
	' content of let-statement	
		...
		'no corresponding for assigning masters with specified function in HFSS, thus skipped translation.
		'no corresponding for assigning masterL with specified function in HFSS, thus skipped translation.
		'no corresponding for assigning masterUD with specified function in HFSS, thus skipped translation.
		'no corresponding for assigning m_lead_pair with specified function in HFSS, thus skipped translation.
...
End Sub
'Invoke TopCell
rfvlsiHFSS_Create_xfm_highk 0,  0,  rfvlsi_ORIENT_R0,  200,  5,  5,  20 ,  20,  0,  0,  2,   true,  true,  "balun"
...
oModule.AssignRadiation Array("NAME:ABC", _
	"Objects:=", Array("ABC"), _
...
Dim faceidPort1
	faceidPort1 = oEditor.GetFaceByPosition(Array("NAME:Parameters", _
	"BodyName:=", "Port1", "XPosition:=", "0.0um", "YPosition:=", _
	"0.0um", "ZPosition:=", "0.0um"))
	Set oModule = oDesign.GetModule("BoundarySetup")
	oModule.AutoIdentifyPorts Array("NAME:Faces", faceidPort1), false, Array("NAME:ReferenceConductors",  _
	"ind"), "1", true
...
oModule.InsertDrivenSweep _
	...
	"SaveFields:=", false, _
	"ExtrapToDC:=", false)
oProject.SaveAs "null.hfss", true

' Solve Setup ---------
	oDesign.Solve Array("Run1")
