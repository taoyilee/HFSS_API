...
oProject.SaveAs "G:\HFSS_SIMULATIONS\T65_XFM\XFM-D150I5O2S2.hfss", true
...
oProject.ChangeProperty Array("NAME:AllTabs", Array("NAME:ProjectVariableTab", Array("NAME:PropServers",  _
  "ProjectVariables"), Array("NAME:ChangedProps", Array("NAME:$OD", "Value:=", "150um"))))
...
End Sub
'Invoke TopCell
rfvlsiHFSS_Create_xfm_highk 0,  0,  rfvlsi_ORIENT_R0,  150,  5,  2,  15,  50,  0,  0,  2
