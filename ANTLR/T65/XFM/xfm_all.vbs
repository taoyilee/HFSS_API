...
oDesktop.OpenProject "F:/Dropbox/ANTLR/skill_to_hfss/nominal.hfss"
Set oProject = oDesktop.GetActiveProject
oProject.SaveAs "G:\HFSS_SIMULATIONS\T65_XFM\HFSS_FILENAME.hfss", true
...
oProject.ChangeProperty Array("NAME:AllTabs", Array("NAME:ProjectVariableTab", Array("NAME:PropServers",  _
  "ProjectVariables"), Array("NAME:ChangedProps", Array("NAME:$M9_WI", "Value:=", "WI_VALum"))))
oProject.ChangeProperty Array("NAME:AllTabs", Array("NAME:ProjectVariableTab", Array("NAME:PropServers",  _
  "ProjectVariables"), Array("NAME:ChangedProps", Array("NAME:$M9_WO", "Value:=", "WO_VALum"))))
oProject.ChangeProperty Array("NAME:AllTabs", Array("NAME:ProjectVariableTab", Array("NAME:PropServers",  _
  "ProjectVariables"), Array("NAME:ChangedProps", Array("NAME:$M9_S", "Value:=", "S_VALum"))))
oProject.ChangeProperty Array("NAME:AllTabs", Array("NAME:ProjectVariableTab", Array("NAME:PropServers",  _
  "ProjectVariables"), Array("NAME:ChangedProps", Array("NAME:$OD", "Value:=", "OD_VALum"))))
...
Sub rfvlsiHFSS_Create_balun_half(rfvlsi_pcellOffsetX0, rfvlsi_pcellOffsetY0, rfvlsi_pcellOffsetORIENT, OD , W , W_INC , S , B_TK , A_TK , LOP , ROP , align_left )
	' content of let-statement	
		...
		rfvlsiHFSS_Create_xfm_half rfvlsi_newOriginX(rfvlsi_pcellOffsetX0, rfvlsi_pcellOffsetY0, rfvlsi_pcellOffsetORIENT, (0), (0), rfvlsi_ORIENT_R0), _
			...
			OD,W,S,B_TK,A_TK,LOP,ROP,9,8,true,true
...
Sub rfvlsiHFSS_Create_balun_halfud(rfvlsi_pcellOffsetX0, rfvlsi_pcellOffsetY0, rfvlsi_pcellOffsetORIENT, OD , W , W_INC , S , LOP , ROP , LEADDYI , LEADDYO , align_left )
	' content of let-statement	
		' local variable declarations
		rfvlsiHFSS_Create_balun_half rfvlsi_newOriginX(rfvlsi_pcellOffsetX0, rfvlsi_pcellOffsetY0, rfvlsi_pcellOffsetORIENT, (0), (0), rfvlsi_ORIENT_R0), _
			rfvlsi_newOriginY(rfvlsi_pcellOffsetX0, rfvlsi_pcellOffsetY0, rfvlsi_pcellOffsetORIENT, (0), (0), rfvlsi_ORIENT_R0), _	
			rfvlsi_newORIENT(rfvlsi_pcellOffsetORIENT, rfvlsi_ORIENT_R0), _
			OD,W,W_INC,S,0.0,0.0,(LOP+LEADDYI),(ROP+LEADDYO),align_left
...
Sub rfvlsiHFSS_Create_balun_sec(rfvlsi_pcellOffsetX0, rfvlsi_pcellOffsetY0, rfvlsi_pcellOffsetORIENT, OD , WI , WO , S , CW , B_TK , LEADDYI , LEADDYO , A_TK , DIV , LOP  )
	' content of let-statement	
		'Redudant ID at current scope: inst, polyg
		' local variable declarations
		pi = 3.141592
		P = (S+WI)
		...
		rfvlsiHFSS_Create_xfm_halfud rfvlsi_newOriginX(rfvlsi_pcellOffsetX0, rfvlsi_pcellOffsetY0, rfvlsi_pcellOffsetORIENT, (0), (0), rfvlsi_ORIENT_R0), _
			rfvlsi_newOriginY(rfvlsi_pcellOffsetX0, rfvlsi_pcellOffsetY0, rfvlsi_pcellOffsetORIENT, (0), (0), rfvlsi_ORIENT_R0), _	
			rfvlsi_newORIENT(rfvlsi_pcellOffsetORIENT, rfvlsi_ORIENT_R0), _
			OD,WI,S,B_TK,A_TK,LOP,0.0,LEADDYI,LEADDYO,"9","9",true,true
...
Sub rfvlsiHFSS_Create_under(rfvlsi_pcellOffsetX0, rfvlsi_pcellOffsetY0, rfvlsi_pcellOffsetORIENT, W , WX , S , TOP_ME , BTM_ME , NT , INDDMY , INDDMYP , dummy )
	' content of let-statement	
		...
		rfvlsiHFSS_Create_vias rfvlsi_newOriginX(rfvlsi_pcellOffsetX0, rfvlsi_pcellOffsetY0, rfvlsi_pcellOffsetORIENT, (0), (((NT)*(P)-W)), rfvlsi_ORIENT_R0), _
			...
			rfvlsi_newORIENT(rfvlsi_pcellOffsetORIENT, rfvlsi_ORIENT_R0), _
			W,WX,TOP_ME,BTM_ME,true,true,false,false
		...
		If (dummy) Then
			' no need to translate dbCreateRect() function to HFSS
		End If
...
Sub rfvlsiHFSS_Create_vias_diagonal(rfvlsi_pcellOffsetX0, rfvlsi_pcellOffsetY0, rfvlsi_pcellOffsetORIENT, Length , Width , TOP_ME , BTM_ME )
	' content of let-statement	
		...
		For m = ((BTM_ME-1)) to ((TOP_ME-2))
			...
			len_Vert_Edge = (((Length-(num_Vert_Vias)*(ViaWidthVec(m)))-((num_Vert_Vias-1))*(ViaSpacingVec(m))))/(2)
			num_Horz_Vias = floor(((((Width-(2)*(ViaDiagonalEncVec(m)))+ViaSpacingVec(m))-ViaWidthVec(m)))/(Pitch))
			len_Horz_delta = (((((Width-(num_Horz_Vias)*(ViaWidthVec(m)))-((num_Horz_Vias-1))*(ViaSpacingVec(m)))-(2)*(ViaDiagonalEncVec(m)))-ViaWidthVec(m)))/(2)
...
Sub rfvlsiHFSS_Create_xfm_body(rfvlsi_pcellOffsetX0, rfvlsi_pcellOffsetY0, rfvlsi_pcellOffsetORIENT, OD , W , LOP , ROP , METAL )
	' content of let-statement	
		' local variable declarations
		pi = 3.141592
		C = roundtogrid((W)*(tan((pi)/(8))))
...
Sub rfvlsiHFSS_Create_xfm_cross(rfvlsi_pcellOffsetX0, rfvlsi_pcellOffsetY0, rfvlsi_pcellOffsetORIENT, WI , WO , S , TOP_ME , BTM_ME , viat , viad , top )
	' content of let-statement	
		' local variable declarations
		pi = 3.141592
		...
		If (top) Then
			rfvlsiHFSS_Create_xfm_diag rfvlsi_newOriginX(rfvlsi_pcellOffsetX0, rfvlsi_pcellOffsetY0, rfvlsi_pcellOffsetORIENT, (0), (0), rfvlsi_ORIENT_R0), _
				rfvlsi_newOriginY(rfvlsi_pcellOffsetX0, rfvlsi_pcellOffsetY0, rfvlsi_pcellOffsetORIENT, (0), (0), rfvlsi_ORIENT_R0), _	
				rfvlsi_newORIENT(rfvlsi_pcellOffsetORIENT, rfvlsi_ORIENT_R0), WI,WO,S,TOP_ME

		Else
			rfvlsiHFSS_Create_xfm_diag rfvlsi_newOriginX(rfvlsi_pcellOffsetX0, rfvlsi_pcellOffsetY0, rfvlsi_pcellOffsetORIENT, (0), (0), rfvlsi_ORIENT_R0), _
				rfvlsi_newOriginY(rfvlsi_pcellOffsetX0, rfvlsi_pcellOffsetY0, rfvlsi_pcellOffsetORIENT, (0), (0), rfvlsi_ORIENT_R0), _	
				rfvlsi_newORIENT(rfvlsi_pcellOffsetORIENT, rfvlsi_ORIENT_R0), WI,WO,S,BTM_ME

		End If

		rfvlsiHFSS_Create_vias rfvlsi_newOriginX(rfvlsi_pcellOffsetX0, rfvlsi_pcellOffsetY0, rfvlsi_pcellOffsetORIENT, (0), ((-OOCH)), rfvlsi_ORIENT_MX), _
			rfvlsi_newOriginY(rfvlsi_pcellOffsetX0, rfvlsi_pcellOffsetY0, rfvlsi_pcellOffsetORIENT, (0), ((-OOCH)), rfvlsi_ORIENT_MX), _	
			rfvlsi_newORIENT(rfvlsi_pcellOffsetORIENT, rfvlsi_ORIENT_MX), _
			WO,WO,TOP_ME,BTM_ME,true,true,false,false

		rfvlsiHFSS_Create_vias rfvlsi_newOriginX(rfvlsi_pcellOffsetX0, rfvlsi_pcellOffsetY0, rfvlsi_pcellOffsetORIENT, (((WI+WO)+(2)*(S))), (OOCH), rfvlsi_ORIENT_R0), _
			rfvlsi_newOriginY(rfvlsi_pcellOffsetX0, rfvlsi_pcellOffsetY0, rfvlsi_pcellOffsetORIENT, (((WI+WO)+(2)*(S))), (OOCH), rfvlsi_ORIENT_R0), _	
			rfvlsi_newORIENT(rfvlsi_pcellOffsetORIENT, rfvlsi_ORIENT_R0), _
			WO,WO,TOP_ME,BTM_ME,true,true,false,false
...
strLibName = "RFVLSI_N65"
strCellName = "xfm_dmy"
Sub rfvlsiHFSS_Create_xfm_dmy(rfvlsi_pcellOffsetX0, rfvlsi_pcellOffsetY0, rfvlsi_pcellOffsetORIENT, OD , layer , purpose )
	' content of let-statement	
		' local variable declarations
		pi = 3.141592
		DIV = (2+Sqr(2))
		...
		BA = roundtogrid((B)/(2))
		BB = (B-BA)
		' no need to translate dbCreatePolygon() function to HFSS
End Sub
' This source code is generated by NCTU RFVLSI Lab SKILL -> HFSS VBscript translator.
' This SKILL/HFSS VBsciprt Translator is a intellectual property of RFVLSI Lab, NCTU, Taiwan
' All rights reserved. 2012. Confidential, and intended for internal use only. 
...
Sub rfvlsiHFSS_Create_xfm_half(rfvlsi_pcellOffsetX0, rfvlsi_pcellOffsetY0, rfvlsi_pcellOffsetORIENT, OD , W , S , B_TK , A_TK , LOP , ROP , TOP_ME , BTM_ME ,  via_to_next , via_diag )
	' content of let-statement	
		' local variable declarations
		pi = 3.141592
		P = (S+W)
		...
		If (en_dmy) Then
			rfvlsiHFSS_Create_xfm_dmy rfvlsi_newOriginX(rfvlsi_pcellOffsetX0, rfvlsi_pcellOffsetY0, rfvlsi_pcellOffsetORIENT, (0), (0), rfvlsi_ORIENT_R0), _
				rfvlsi_newOriginY(rfvlsi_pcellOffsetX0, rfvlsi_pcellOffsetY0, rfvlsi_pcellOffsetORIENT, (0), (0), rfvlsi_ORIENT_R0), _	
				rfvlsi_newORIENT(rfvlsi_pcellOffsetORIENT, rfvlsi_ORIENT_R0), _
				OD,"RFVLSI","drawing"
...
Sub rfvlsiHFSS_Create_xfm_halfud(rfvlsi_pcellOffsetX0, rfvlsi_pcellOffsetY0, rfvlsi_pcellOffsetORIENT, OD , W , S , B_TK , A_TK , LOP , ROP , LEADDYI , LEADDYO , TOP_ME , BTM_ME , via_to_next , via_diag )
	' content of let-statement	
		' local variable declarations
		rfvlsiHFSS_Create_xfm_half rfvlsi_newOriginX(rfvlsi_pcellOffsetX0, rfvlsi_pcellOffsetY0, rfvlsi_pcellOffsetORIENT, (0), (0), rfvlsi_ORIENT_R0), _
			rfvlsi_newOriginY(rfvlsi_pcellOffsetX0, rfvlsi_pcellOffsetY0, rfvlsi_pcellOffsetORIENT, (0), (0), rfvlsi_ORIENT_R0), _	
			rfvlsi_newORIENT(rfvlsi_pcellOffsetORIENT, rfvlsi_ORIENT_R0), _
			OD,W,S,B_TK,A_TK,(LOP+LEADDYI),(ROP+LEADDYO),TOP_ME,BTM_ME,via_to_next,via_diag
...
Sub rfvlsiHFSS_Create_xfm_highk(rfvlsi_pcellOffsetX0, rfvlsi_pcellOffsetY0, rfvlsi_pcellOffsetORIENT, OD , WI , WO , ROP , LEAD , LEADDYI , LEADDYO , S  )
	' content of let-statement	
		' local variable declarations
		PI = (WI+S)
		PO = (WO+S)
		...
		' no need to translate dbCreateLabel() function to HFSS
		' no need to translate dbCreateLabel() function to HFSS
		' no need to translate dbCreateLabel() function to HFSS
		' no need to translate dbCreateLabel() function to HFSS
		rfvlsiHFSS_Create_xfm_highk_pri rfvlsi_newOriginX(rfvlsi_pcellOffsetX0, rfvlsi_pcellOffsetY0, rfvlsi_pcellOffsetORIENT, (0), (0), rfvlsi_ORIENT_R0), _
			rfvlsi_newOriginY(rfvlsi_pcellOffsetX0, rfvlsi_pcellOffsetY0, rfvlsi_pcellOffsetORIENT, (0), (0), rfvlsi_ORIENT_R0), _	
			rfvlsi_newORIENT(rfvlsi_pcellOffsetORIENT, rfvlsi_ORIENT_R0), _
			OD,WI,WO,2.0,S,0.0,LEADDYI,LEADDYO,0.0,ROP,LOP,true
		...
		rfvlsiHFSS_Create_balun_sec rfvlsi_newOriginX(rfvlsi_pcellOffsetX0, rfvlsi_pcellOffsetY0, rfvlsi_pcellOffsetORIENT, (PO), (0), rfvlsi_ORIENT_R0), _
			...
			rfvlsi_newORIENT(rfvlsi_pcellOffsetORIENT, rfvlsi_ORIENT_R0), _
			(OD-(2)*(PO)),WI,WO,S,20.0,0.0,LEADDYI,LEADDYO,0.0,3.414,LOP

		rfvlsiHFSS_Create_xfm_lead rfvlsi_newOriginX(rfvlsi_pcellOffsetX0, rfvlsi_pcellOffsetY0, rfvlsi_pcellOffsetORIENT, ((-S)), (LOP), rfvlsi_ORIENT_MY), _
			rfvlsi_newOriginY(rfvlsi_pcellOffsetX0, rfvlsi_pcellOffsetY0, rfvlsi_pcellOffsetORIENT, ((-S)), (LOP), rfvlsi_ORIENT_MY), _	
			rfvlsi_newORIENT(rfvlsi_pcellOffsetORIENT, rfvlsi_ORIENT_MY), _
			LEAD,WI,1.0,"P1","dummy1","9","9"

		rfvlsiHFSS_Create_xfm_lead rfvlsi_newOriginX(rfvlsi_pcellOffsetX0, rfvlsi_pcellOffsetY0, rfvlsi_pcellOffsetORIENT, ((-S)), (((-LOP)-WI)), rfvlsi_ORIENT_MY), _
			rfvlsi_newOriginY(rfvlsi_pcellOffsetX0, rfvlsi_pcellOffsetY0, rfvlsi_pcellOffsetORIENT, ((-S)), (((-LOP)-WI)), rfvlsi_ORIENT_MY), _	
			rfvlsi_newORIENT(rfvlsi_pcellOffsetORIENT, rfvlsi_ORIENT_MY), _
			LEAD,WI,1.0,"N1","dummy1","9","9"
		...
		rfvlsiHFSS_Create_xfm_lead rfvlsi_newOriginX(rfvlsi_pcellOffsetX0, rfvlsi_pcellOffsetY0, rfvlsi_pcellOffsetORIENT, (OD), ((ROP+LEADDYO)), rfvlsi_ORIENT_R0), _
			rfvlsi_newOriginY(rfvlsi_pcellOffsetX0, rfvlsi_pcellOffsetY0, rfvlsi_pcellOffsetORIENT, (OD), ((ROP+LEADDYO)), rfvlsi_ORIENT_R0), _	
			rfvlsi_newORIENT(rfvlsi_pcellOffsetORIENT, rfvlsi_ORIENT_R0), _
			LEAD,WO,1.0,"P2","dummy1","9","8"

		rfvlsiHFSS_Create_xfm_lead rfvlsi_newOriginX(rfvlsi_pcellOffsetX0, rfvlsi_pcellOffsetY0, rfvlsi_pcellOffsetORIENT, (OD), ((((-ROP)-WO)+LEADDYO)), rfvlsi_ORIENT_R0), _
			rfvlsi_newOriginY(rfvlsi_pcellOffsetX0, rfvlsi_pcellOffsetY0, rfvlsi_pcellOffsetORIENT, (OD), ((((-ROP)-WO)+LEADDYO)), rfvlsi_ORIENT_R0), _	
			rfvlsi_newORIENT(rfvlsi_pcellOffsetORIENT, rfvlsi_ORIENT_R0), _
			LEAD,WO,1.0,"N2","dummy1","9","8"
...
Sub rfvlsiHFSS_Create_xfm_highk_pri(rfvlsi_pcellOffsetX0, rfvlsi_pcellOffsetY0, rfvlsi_pcellOffsetORIENT, OD , WI , WO , M8_S , S , B_TK , LEADDYI , LEADDYO , A_TK , ROP , LOP ,  text )
	' content of let-statement	
		...
		rfvlsiHFSS_Create_balun_halfud rfvlsi_newOriginX(rfvlsi_pcellOffsetX0, rfvlsi_pcellOffsetY0, rfvlsi_pcellOffsetORIENT, (0), (0), rfvlsi_ORIENT_R0), _
			rfvlsi_newOriginY(rfvlsi_pcellOffsetX0, rfvlsi_pcellOffsetY0, rfvlsi_pcellOffsetORIENT, (0), (0), rfvlsi_ORIENT_R0), _	
			rfvlsi_newORIENT(rfvlsi_pcellOffsetORIENT, rfvlsi_ORIENT_R0), _
			OD,WO,1.5,S,((LOP+M8_S)+WI),ROP,LEADDYI,LEADDYO,true
		...
		rfvlsiHFSS_Create_balun_halfud rfvlsi_newOriginX(rfvlsi_pcellOffsetX0, rfvlsi_pcellOffsetY0, rfvlsi_pcellOffsetORIENT, (((WO+WI)+(2)*(S))), (0), rfvlsi_ORIENT_R0), _
			...
			rfvlsi_newORIENT(rfvlsi_pcellOffsetORIENT, rfvlsi_ORIENT_R0), _
			(OD-(2)*((PI+PO))),WO,1.5,S,((LOP+M8_S)+WI),(WI+M8_S),LEADDYI,LEADDYO,false
		...
		rfvlsiHFSS_Create_xfm_cross rfvlsi_newOriginX(rfvlsi_pcellOffsetX0, rfvlsi_pcellOffsetY0, rfvlsi_pcellOffsetORIENT, ((((2)*(WO)+(2)*(S))+WI)), (0), rfvlsi_ORIENT_MY), _
			...
			rfvlsi_newORIENT(rfvlsi_pcellOffsetORIENT, rfvlsi_ORIENT_MY), _
			WI,WO,S,9,8,true,true,false

End Sub
' This source code is generated by NCTU RFVLSI Lab SKILL -> HFSS VBscript translator.
' This SKILL/HFSS VBsciprt Translator is a intellectual property of RFVLSI Lab, NCTU, Taiwan
' All rights reserved. 2012. Confidential, and intended for internal use only. 
Sub rfvlsiHFSS_Create_xfm_diag(rfvlsi_pcellOffsetX0, rfvlsi_pcellOffsetY0, rfvlsi_pcellOffsetORIENT, WI , WO , S , METAL )
	' content of let-statement	
		' local variable declarations
		pi = 3.141592
		P = (S+WO)
...
Sub rfvlsiHFSS_Create_xfm_lead(rfvlsi_pcellOffsetX0, rfvlsi_pcellOffsetY0, rfvlsi_pcellOffsetORIENT, L , W , WD , PINTXT , PINP , TOP_ME , BTM_ME  )
	' content of let-statement	
		' local variable declarations
...
End Sub
'Invoke TopCell
rfvlsiHFSS_Create_xfm_highk 0,  0,  rfvlsi_ORIENT_R0,  OD_VAL,  WI_VAL,  WO_VAL,  15,  50,  0,  0,  S_VAL
...
oModule.AutoIdentifyPorts Array("NAME:Faces", 5543, 5555, 5567, 5579), false,_
