...
oDesktop.OpenProject "F:\Dropbox\ANTLR\HFSS_API\examples\T65_SYM_4T\nominal.hfss"
Set oProject = oDesktop.GetActiveProject
oProject.SaveAs "G:\HFSS_SIMULATIONS\T65_SYM_4T\HFSS_FILENAME.hfss", true
	...
	' content of let-statement	
		...
		If ((S<=(2.0)*(Sqr(2)))) Then
			rfvlsiHFSS_Create_xfm_halfud rfvlsi_newOriginX(rfvlsi_pcellOffsetX0, rfvlsi_pcellOffsetY0, rfvlsi_pcellOffsetORIENT, (((-OD))/(2)), (0), rfvlsi_ORIENT_R0), _
				...
				rfvlsi_newORIENT(rfvlsi_pcellOffsetORIENT, rfvlsi_ORIENT_R0), _
				OD,W,S,0.0,0.0,((OOCH+roundtogrid(((2)*(Sqr(2.0))-S)))+0.01),OPENING,0.0,0.0,true,TOP_ME,BTM_ME,via_to_next,via_to_next

		Else
			rfvlsiHFSS_Create_xfm_halfud rfvlsi_newOriginX(rfvlsi_pcellOffsetX0, rfvlsi_pcellOffsetY0, rfvlsi_pcellOffsetORIENT, (((-OD))/(2)), (0), rfvlsi_ORIENT_R0), _
				rfvlsi_newOriginY(rfvlsi_pcellOffsetX0, rfvlsi_pcellOffsetY0, rfvlsi_pcellOffsetORIENT, (((-OD))/(2)), (0), rfvlsi_ORIENT_R0), _	
				rfvlsi_newORIENT(rfvlsi_pcellOffsetORIENT, rfvlsi_ORIENT_R0), _
				OD,W,S,0.0,0.0,OOCH,OPENING,0.0,0.0,true,TOP_ME,BTM_ME,via_to_next,via_to_next
...
strLibName = "RFVLSI_N65"
strCellName = "ind_sym"
Sub rfvlsiHFSS_Create_ind_sym(rfvlsi_pcellOffsetX0, rfvlsi_pcellOffsetY0, rfvlsi_pcellOffsetORIENT, OD , W , OPENING , LEAD , S , TOP_ME , NT , L1 , BTM_ME , dummy , DUMMYL , NT_N )
	' content of let-statement	
		' local variable declarations
		P = (W+S)
		...
		rfvlsi_newOriginY(rfvlsi_pcellOffsetX0, rfvlsi_pcellOffsetY0, rfvlsi_pcellOffsetORIENT, (0), (0), rfvlsi_ORIENT_R0), _	
		rfvlsi_newORIENT(rfvlsi_pcellOffsetORIENT, rfvlsi_ORIENT_R0), _
		(OD-(4)*(P)),W,S,(2)*(W),TOP_ME,BTM_ME,true,dummy,"RFVLSI"
		...
		rfvlsi_newORIENT(rfvlsi_pcellOffsetORIENT, rfvlsi_ORIENT_MY), _
		(OD-(2)*(P)),W,S,(2)*(W),TOP_ME,BTM_ME,true,dummy,"RFVLSI"
		...
		rfvlsi_newOriginY(rfvlsi_pcellOffsetX0, rfvlsi_pcellOffsetY0, rfvlsi_pcellOffsetORIENT, (0), (0), rfvlsi_ORIENT_R0), _	
		rfvlsi_newORIENT(rfvlsi_pcellOffsetORIENT, rfvlsi_ORIENT_R0), _
		(OD-(6)*(P)),W,S,0,TOP_ME,BTM_ME,false,dummy,"RFVLSI"
		...
		Else
			CMetalPolygon ((MET-1)), _
				...
				Array(_
					...
					rfvlsi_newOriginX(rfvlsi_PCellOffsetX0, rfvlsi_PCellOffsetY0, rfvlsi_PCellOffsetORIENT, ((OO-W)), (OOCH), rfvlsi_ORIENT_R0),_
					rfvlsi_newOriginX(rfvlsi_PCellOffsetX0, rfvlsi_PCellOffsetY0, rfvlsi_PCellOffsetORIENT, (P), ((((-OOCH)+C)+P)), rfvlsi_ORIENT_R0),_
					rfvlsi_newOriginX(rfvlsi_PCellOffsetX0, rfvlsi_PCellOffsetY0, rfvlsi_PCellOffsetORIENT, (0), (((-OOCH)+C)), rfvlsi_ORIENT_R0)), _
				Array(_
					rfvlsi_newOriginY(rfvlsi_PCellOffsetX0, rfvlsi_PCellOffsetY0, rfvlsi_PCellOffsetORIENT, (0), (((-OOCH)+C)), rfvlsi_ORIENT_R0),_
					...
					rfvlsi_newOriginY(rfvlsi_PCellOffsetX0, rfvlsi_PCellOffsetY0, rfvlsi_PCellOffsetORIENT, ((OO-W)), (OOCH), rfvlsi_ORIENT_R0),_
					rfvlsi_newOriginY(rfvlsi_PCellOffsetX0, rfvlsi_PCellOffsetY0, rfvlsi_PCellOffsetORIENT, (P), ((((-OOCH)+C)+P)), rfvlsi_ORIENT_R0),_
					rfvlsi_newOriginY(rfvlsi_PCellOffsetX0, rfvlsi_PCellOffsetY0, rfvlsi_PCellOffsetORIENT, (0), (((-OOCH)+C)), rfvlsi_ORIENT_R0)) 
		End If
...
End Sub
'Invoke TopCell
													'OD , W , OPENING , LEAD , S , TOP_ME , NT , L1 , BTM_ME , dummy , DUMMYL , NT_N )
rfvlsiHFSS_Create_ind_sym 0,  0,  rfvlsi_ORIENT_R0,  OD_VAL,  W_VAL,  10, 20 , S_VAL,   9, 2 , "1n" , 9 , false , "RFVLSI" , false 
