...
oProject.SaveAs "G:\HFSS_SIMULATIONS\T65_SYM_4T\SYM-D100W2S2.3.hfss", true
...
oProject.ChangeProperty Array("NAME:AllTabs", Array("NAME:ProjectVariableTab", Array("NAME:PropServers",  _
  "ProjectVariables"), Array("NAME:ChangedProps", Array("NAME:$OD", "Value:=", "100um"))))
...
rfvlsiHFSS_Create_ind_sym 0,  0,  rfvlsi_ORIENT_R0,  100,  2,  10, 20 , 2.3,   9, 2 , "1n" , 9 , false , "RFVLSI" , false 
