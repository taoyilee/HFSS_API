...
oProject.SaveAs "G:\HFSS_SIMULATIONS\T65_SYM_4T\SYM-D105W2S2.3.hfss", true
...
oProject.ChangeProperty Array("NAME:AllTabs", Array("NAME:ProjectVariableTab", Array("NAME:PropServers",  _
  "ProjectVariables"), Array("NAME:ChangedProps", Array("NAME:$M9_S", "Value:=", "2.3um"))))
oProject.ChangeProperty Array("NAME:AllTabs", Array("NAME:ProjectVariableTab", Array("NAME:PropServers",  _
  "ProjectVariables"), Array("NAME:ChangedProps", Array("NAME:$OD", "Value:=", "105um"))))
...
rfvlsiHFSS_Create_ind_sym 0,  0,  rfvlsi_ORIENT_R0,  105,  2,  10, 20 , 2.3,   9, 2 , "1n" , 9 , false , "RFVLSI" , false 
