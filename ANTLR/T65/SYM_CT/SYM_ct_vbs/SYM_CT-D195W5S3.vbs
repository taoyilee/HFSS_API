...
oProject.SaveAs "G:\HFSS_SIMULATIONS\T65_SYM_CT\SYM_CT-D195W5S3.hfss", true
...
oProject.ChangeProperty Array("NAME:AllTabs", Array("NAME:ProjectVariableTab", Array("NAME:PropServers",  _
  "ProjectVariables"), Array("NAME:ChangedProps", Array("NAME:$M9_W", "Value:=", "5um"))))
oProject.ChangeProperty Array("NAME:AllTabs", Array("NAME:ProjectVariableTab", Array("NAME:PropServers",  _
...
rfvlsiHFSS_Create_ind_sym_ct 0,  0,  rfvlsi_ORIENT_R0,  195,  5,  18, 20 , 3,   9 , 2 , "1n" , "1n" , 9 , false , "RFVLSI" , false 
