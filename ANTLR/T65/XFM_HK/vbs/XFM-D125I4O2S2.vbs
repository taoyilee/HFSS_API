...
oProject.SaveAs "G:\HFSS_SIMULATIONS\T65_XFM_HK_ANTLR\XFM-D125I4O2S2.hfss", true
...
oProject.ChangeProperty Array("NAME:AllTabs", Array("NAME:ProjectVariableTab", Array("NAME:PropServers",  _
  "ProjectVariables"), Array("NAME:ChangedProps", Array("NAME:$M9_WI", "Value:=", "4um"))))
oProject.ChangeProperty Array("NAME:AllTabs", Array("NAME:ProjectVariableTab", Array("NAME:PropServers",  _
...
rfvlsiHFSS_Create_xfm_highk 0,  0,  rfvlsi_ORIENT_R0,  125,  4,  2,   7,   40,    0, 		0,		 2,   true,  true,  "balun"
