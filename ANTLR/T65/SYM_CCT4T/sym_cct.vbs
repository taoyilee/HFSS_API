...
oDesktop.OpenProject "F:\Dropbox\ANTLR\HFSS_API\examples\T65_SYM_CCT4T_ANTLR\nominal.hfss"
Set oProject = oDesktop.GetActiveProject
oProject.SaveAs "G:\HFSS_SIMULATIONS\T65_SYM_CCT4T\HFSS_FILENAME.hfss", true
...
oProject.ChangeProperty Array("NAME:AllTabs", Array("NAME:ProjectVariableTab", Array("NAME:PropServers",  _
  "ProjectVariables"), Array("NAME:ChangedProps", Array("NAME:$M9_W", "Value:=", "W_VALum"))))
oProject.ChangeProperty Array("NAME:AllTabs", Array("NAME:ProjectVariableTab", Array("NAME:PropServers",  _
...
' local variable declarations
strLibName = "RFVLSI_N65"
strCellName = "sym_cct4T"
Sub rfvlsiHFSS_Create_sym_cct4T(rfvlsi_pcellOffsetX0, rfvlsi_pcellOffsetY0, rfvlsi_pcellOffsetORIENT, OD , W , OPENING , OPENCT , LEAD , S , L12 , L34 , dummy , NT_N )
	' content of let-statement	
		'Redudant ID at current scope: i
		' local variable declarations
		P = (W+S)


		rfvlsiHFSS_Create_sym_cct4T_t rfvlsi_newOriginX(rfvlsi_pcellOffsetX0, rfvlsi_pcellOffsetY0, rfvlsi_pcellOffsetORIENT, (0), (0), rfvlsi_ORIENT_R0), _
			rfvlsi_newOriginY(rfvlsi_pcellOffsetX0, rfvlsi_pcellOffsetY0, rfvlsi_pcellOffsetORIENT, (0), (0), rfvlsi_ORIENT_R0), _	
			rfvlsi_newORIENT(rfvlsi_pcellOffsetORIENT, rfvlsi_ORIENT_R0), _
			OD,W,S,OPENING,"9","8",true,dummy

		rfvlsiHFSS_Create_sym_cct4T_t rfvlsi_newOriginX(rfvlsi_pcellOffsetX0, rfvlsi_pcellOffsetY0, rfvlsi_pcellOffsetORIENT, (0), (0), rfvlsi_ORIENT_MY), _
			...
			(OD-(2)*(P)),W,S,(2)*(W),"9","8",true,dummy

		rfvlsiHFSS_Create_sym_cct4T_t rfvlsi_newOriginX(rfvlsi_pcellOffsetX0, rfvlsi_pcellOffsetY0, rfvlsi_pcellOffsetORIENT, (0), (0), rfvlsi_ORIENT_R0), _
			rfvlsi_newOriginY(rfvlsi_pcellOffsetX0, rfvlsi_pcellOffsetY0, rfvlsi_pcellOffsetORIENT, (0), (0), rfvlsi_ORIENT_R0), _	
			rfvlsi_newORIENT(rfvlsi_pcellOffsetORIENT, rfvlsi_ORIENT_R0), _
			(OD-(4)*(P)),W,S,(2)*(W),"9","8",true,dummy

		rfvlsiHFSS_Create_sym_cct4T_t rfvlsi_newOriginX(rfvlsi_pcellOffsetX0, rfvlsi_pcellOffsetY0, rfvlsi_pcellOffsetORIENT, (0), (0), rfvlsi_ORIENT_R0), _
			rfvlsi_newOriginY(rfvlsi_pcellOffsetX0, rfvlsi_pcellOffsetY0, rfvlsi_pcellOffsetORIENT, (0), (0), rfvlsi_ORIENT_R0), _	
			rfvlsi_newORIENT(rfvlsi_pcellOffsetORIENT, rfvlsi_ORIENT_R0), _
			(OD-(6)*(P)),W,S,OPENCT,"9","8",false,dummy

		rfvlsiHFSS_Create_lead_pair rfvlsi_newOriginX(rfvlsi_pcellOffsetX0, rfvlsi_pcellOffsetY0, rfvlsi_pcellOffsetORIENT, ((OD)/(2)), (0), rfvlsi_ORIENT_R0), _
		...
		rfvlsiHFSS_Create_lead_pair rfvlsi_newOriginX(rfvlsi_pcellOffsetX0, rfvlsi_pcellOffsetY0, rfvlsi_pcellOffsetORIENT, ((((OD)/(2)-(4)*(P))+S)), (0), rfvlsi_ORIENT_R0), _
			rfvlsi_newOriginY(rfvlsi_pcellOffsetX0, rfvlsi_pcellOffsetY0, rfvlsi_pcellOffsetORIENT, ((((OD)/(2)-(4)*(P))+S)), (0), rfvlsi_ORIENT_R0), _	
			rfvlsi_newORIENT(rfvlsi_pcellOffsetORIENT, rfvlsi_ORIENT_R0), _
			W,OPENCT,((LEAD+(3)*(P))+S),"9","7",dummy,"CTp","CTn"
...
' local variable declarations
strLibName = "RFVLSI_N65"
strCellName = "sym_cct4T_t"
Sub rfvlsiHFSS_Create_sym_cct4T_t(rfvlsi_pcellOffsetX0, rfvlsi_pcellOffsetY0, rfvlsi_pcellOffsetORIENT, OD , W , S , OPENING , TOP_ME , BTM_ME , under , dummy )
	' content of let-statement	
		'Redudant ID at current scope: via_to_next
		' local variable declarations
		P = (W+S)
		'no corresponding for assigning master_cross with specified function in HFSS, thus skipped translation.
		rfvlsiHFSS_Create_xfm_halfud rfvlsi_newOriginX(rfvlsi_pcellOffsetX0, rfvlsi_pcellOffsetY0, rfvlsi_pcellOffsetORIENT, (((-OD))/(2)), (0), rfvlsi_ORIENT_R0), _
			rfvlsi_newOriginY(rfvlsi_pcellOffsetX0, rfvlsi_pcellOffsetY0, rfvlsi_pcellOffsetORIENT, (((-OD))/(2)), (0), rfvlsi_ORIENT_R0), _	
			rfvlsi_newORIENT(rfvlsi_pcellOffsetORIENT, rfvlsi_ORIENT_R0), _
			OD,W,S,0.0,0.0,(S+(W)/(2)),OPENING,0.0,0.0,true,"9","9",false,false
		...
		If (under) Then
			...
			rfvlsiHFSS_Create_xfm_cross rfvlsi_newOriginX(rfvlsi_pcellOffsetX0, rfvlsi_pcellOffsetY0, rfvlsi_pcellOffsetORIENT, (((((-OD))/(2)+P)+W)), (0), rfvlsi_ORIENT_MY), _
				...
				rfvlsi_newORIENT(rfvlsi_pcellOffsetORIENT, rfvlsi_ORIENT_MY), _
				S,W,0.0,9,9,dummy,false,false,true
...
Sub rfvlsiHFSS_Create_xfm_cross(rfvlsi_pcellOffsetX0, rfvlsi_pcellOffsetY0, rfvlsi_pcellOffsetORIENT, WI , WO , S , TOP_ME , BTM_ME , dummy , viat , viad , top )
	' content of let-statement	
		...
		If ((((2)*(S)+WI)<=(2.0)*(Sqr(2.0)))) Then			
			rfvlsiHFSS_Create_vias rfvlsi_newOriginX(rfvlsi_pcellOffsetX0, rfvlsi_pcellOffsetY0, rfvlsi_pcellOffsetORIENT, (0), (((-OOCH)-(roundtogrid(((2.0)*(Sqr(2.0))-WI))))), rfvlsi_ORIENT_MX), _
			rfvlsi_newOriginY(rfvlsi_pcellOffsetX0, rfvlsi_pcellOffsetY0, rfvlsi_pcellOffsetORIENT, (0), (((-OOCH)-(roundtogrid(((2.0)*(Sqr(2.0))-WI))))), rfvlsi_ORIENT_MX), _	
			rfvlsi_newORIENT(rfvlsi_pcellOffsetORIENT, rfvlsi_ORIENT_MX), _
			WO,WO,TOP_ME,BTM_ME,true,true,false,false,true

		rfvlsiHFSS_Create_vias rfvlsi_newOriginX(rfvlsi_pcellOffsetX0, rfvlsi_pcellOffsetY0, rfvlsi_pcellOffsetORIENT, (((WI+WO)+(2)*(S))), ((OOCH+(roundtogrid(((2.0)*(Sqr(2.0))-WI))))), rfvlsi_ORIENT_R0), _
			rfvlsi_newOriginY(rfvlsi_pcellOffsetX0, rfvlsi_pcellOffsetY0, rfvlsi_pcellOffsetORIENT, (((WI+WO)+(2)*(S))), ((OOCH+(roundtogrid(((2.0)*(Sqr(2.0))-WI))))), rfvlsi_ORIENT_R0), _	
			rfvlsi_newORIENT(rfvlsi_pcellOffsetORIENT, rfvlsi_ORIENT_R0), _
			WO,WO,TOP_ME,BTM_ME,true,true,false,false,true
	...
	' content of let-statement	
		...
		If ((((2)*(S)+WI)<=(2.0)*(Sqr(2)))) Then				
			...
			Array(_
				...
				rfvlsi_newOriginX(rfvlsi_PCellOffsetX0, rfvlsi_PCellOffsetY0, rfvlsi_PCellOffsetORIENT, (0), ((-(OOCH+roundtogrid(((2)*(Sqr(2.0))-WI))))), rfvlsi_ORIENT_R0),_
				rfvlsi_newOriginX(rfvlsi_PCellOffsetX0, rfvlsi_PCellOffsetY0, rfvlsi_PCellOffsetORIENT, (WO), ((-(OOCH+roundtogrid(((2)*(Sqr(2.0))-WI))))), rfvlsi_ORIENT_R0),_
				...
				rfvlsi_newOriginX(rfvlsi_PCellOffsetX0, rfvlsi_PCellOffsetY0, rfvlsi_PCellOffsetORIENT, (OO), ((OOCH+roundtogrid(((2)*(Sqr(2.0))-WI)))), rfvlsi_ORIENT_R0),_
				rfvlsi_newOriginX(rfvlsi_PCellOffsetX0, rfvlsi_PCellOffsetY0, rfvlsi_PCellOffsetORIENT, ((OO-WO)), ((OOCH+roundtogrid(((2)*(Sqr(2.0))-WI)))), rfvlsi_ORIENT_R0),_
			...
			Array(_
				...
				rfvlsi_newOriginY(rfvlsi_PCellOffsetX0, rfvlsi_PCellOffsetY0, rfvlsi_PCellOffsetORIENT, (0), ((-(OOCH+roundtogrid(((2)*(Sqr(2.0))-WI))))), rfvlsi_ORIENT_R0),_
				rfvlsi_newOriginY(rfvlsi_PCellOffsetX0, rfvlsi_PCellOffsetY0, rfvlsi_PCellOffsetORIENT, (WO), ((-(OOCH+roundtogrid(((2)*(Sqr(2.0))-WI))))), rfvlsi_ORIENT_R0),_
				...
				rfvlsi_newOriginY(rfvlsi_PCellOffsetX0, rfvlsi_PCellOffsetY0, rfvlsi_PCellOffsetORIENT, (OO), ((OOCH+roundtogrid(((2)*(Sqr(2.0))-WI)))), rfvlsi_ORIENT_R0),_
				rfvlsi_newOriginY(rfvlsi_PCellOffsetX0, rfvlsi_PCellOffsetY0, rfvlsi_PCellOffsetORIENT, ((OO-WO)), ((OOCH+roundtogrid(((2)*(Sqr(2.0))-WI)))), rfvlsi_ORIENT_R0),_
...
'Invoke TopCell										    ' OD    , W  , OPENING , OPENCT , LEAD , S , L12 , L34 , dummy , NT_N 
rfvlsiHFSS_Create_sym_cct4T 0,  0,  rfvlsi_ORIENT_R0,  OD_VAL,  W_VAL,  14,  8, 20,  S_VAL, 1,  1,   true,  true
...
oModule.AutoIdentifyPorts Array("NAME:Faces", 26981, 27155, 26993, 27005), false,_
