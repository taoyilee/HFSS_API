...
oProject.SaveAs "G:\HFSS_SIMULATIONS\T65_SYM_CCT4T\SYM_CCT4T-D85W2S2.hfss", true
...
oProject.ChangeProperty Array("NAME:AllTabs", Array("NAME:ProjectVariableTab", Array("NAME:PropServers",  _
  "ProjectVariables"), Array("NAME:ChangedProps", Array("NAME:$OD", "Value:=", "85um"))))
...
rfvlsiHFSS_Create_sym_cct4T 0,  0,  rfvlsi_ORIENT_R0,  85,  2,  14,  8, 20,  2, 1,  1,   true,  true
