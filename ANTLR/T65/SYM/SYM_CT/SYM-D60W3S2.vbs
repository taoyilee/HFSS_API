...
oProject.SaveAs "G:\HFSS_SIMULATIONS\T65_SYM\SYM-D60W3S2.hfss", true
...
oProject.ChangeProperty Array("NAME:AllTabs", Array("NAME:ProjectVariableTab", Array("NAME:PropServers",  _
  "ProjectVariables"), Array("NAME:ChangedProps", Array("NAME:$OD", "Value:=", "60um"))))
...
rfvlsiHFSS_Create_ind_sym 0,  0,  rfvlsi_ORIENT_R0,  60,  3,  10, 20 , 2,   9, 2 , "1n" , 9 , false , "RFVLSI" , false 
