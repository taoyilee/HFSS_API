...
oProject.SaveAs "G:\HFSS_SIMULATIONS\T65_SYM_CCT\SYM_CCT-D65W3S2.01.hfss", true
...
oProject.ChangeProperty Array("NAME:AllTabs", Array("NAME:ProjectVariableTab", Array("NAME:PropServers",  _
  "ProjectVariables"), Array("NAME:ChangedProps", Array("NAME:$OD", "Value:=", "65um"))))
...
rfvlsiHFSS_Create_ind_sym_cct 0,  0,  rfvlsi_ORIENT_R0,  65,  3,  10, 6, 20 , 2.01,   9 , 2 , "1n" , "1n" , 9 , false , "RFVLSI" , false 
