...
oDesktop.OpenProject "F:\Dropbox\ANTLR\HFSS_API\examples\T65_SYM_CCT_ANTLR\nominal.hfss"
Set oProject = oDesktop.GetActiveProject
oProject.SaveAs "G:\HFSS_SIMULATIONS\T65_SYM_CCT\HFSS_FILENAME.hfss", true
...
strLibName = "RFVLSI_N65"
strCellName = "ind_sym_cct"
Sub rfvlsiHFSS_Create_ind_sym_cct(rfvlsi_pcellOffsetX0, rfvlsi_pcellOffsetY0, rfvlsi_pcellOffsetORIENT, OD , W , OPENING, OPENCT, LEAD , S , TOP_ME , NT , L1A , L1B , BTM_ME , dummy , DUMMYL , NT_N )
		P = W+S		
		...
		If (NT mod 2 = 0) Then
			rfvlsiHFSS_Create_ind_hud_cross rfvlsi_newOriginX(rfvlsi_pcellOffsetX0, rfvlsi_pcellOffsetY0, rfvlsi_pcellOffsetORIENT, (0), (0), rfvlsi_ORIENT_R0), _
				rfvlsi_newOriginY(rfvlsi_pcellOffsetX0, rfvlsi_pcellOffsetY0, rfvlsi_pcellOffsetORIENT, (0), (0), rfvlsi_ORIENT_R0), _	
				rfvlsi_newORIENT(rfvlsi_pcellOffsetORIENT, rfvlsi_ORIENT_R0), _
				(OD-((2)*((NT-1)))*(P)),W,S,(OPENCT-(W/2)),TOP_ME,BTM_ME,false,dummy,"RFVLSI"
		...
		If (NT mod 2 = 0) Then
			...
			If ((NT=2)) Then
				rfvlsiHFSS_Create_xfm_lead rfvlsi_newOriginX(rfvlsi_pcellOffsetX0, rfvlsi_pcellOffsetY0, rfvlsi_pcellOffsetORIENT, (((OD)/(2)-((NT-1))*(P))), (((-W))/(2)), rfvlsi_ORIENT_R0), _
					rfvlsi_newOriginY(rfvlsi_pcellOffsetX0, rfvlsi_pcellOffsetY0, rfvlsi_pcellOffsetORIENT, (((OD)/(2)-((NT-1))*(P))), (((-W))/(2)+OPENCT), rfvlsi_ORIENT_R0), _	
					rfvlsi_newORIENT(rfvlsi_pcellOffsetORIENT, rfvlsi_ORIENT_R0), _
			...
			Else
				rfvlsiHFSS_Create_vias rfvlsi_newOriginX(rfvlsi_pcellOffsetX0, rfvlsi_pcellOffsetY0, rfvlsi_pcellOffsetORIENT, ((((OD)/(2)-(NT)*(P))+S)), (((-W))/(2)), rfvlsi_ORIENT_R0), _
					rfvlsi_newOriginY(rfvlsi_pcellOffsetX0, rfvlsi_pcellOffsetY0, rfvlsi_pcellOffsetORIENT, ((((OD)/(2)-(NT)*(P))+S)), (((-W))/(2)+OPENCT), rfvlsi_ORIENT_R0), _	
					rfvlsi_newORIENT(rfvlsi_pcellOffsetORIENT, rfvlsi_ORIENT_R0), _
					W,W,9,7,true,true,false,falsew
		...
		Else
			...
			rfvlsiHFSS_Create_xfm_lead rfvlsi_newOriginX(rfvlsi_pcellOffsetX0, rfvlsi_pcellOffsetY0, rfvlsi_pcellOffsetORIENT, (((((-OD))/(2)+((NT-1))*(P))+W)), (((-W))/(2)), rfvlsi_ORIENT_R0), _
				rfvlsi_newOriginY(rfvlsi_pcellOffsetX0, rfvlsi_pcellOffsetY0, rfvlsi_pcellOffsetORIENT, (((((-OD))/(2)+((NT-1))*(P))+W)), (((-W))/(2)+OPENCT), rfvlsi_ORIENT_R0), _	
				rfvlsi_newORIENT(rfvlsi_pcellOffsetORIENT, rfvlsi_ORIENT_R0), _
				(((LEAD+OD)-(NT)*(P))+S),W,1.0,"CTp","dummy1","7","7",DUMMYL,"drawing",dummy
			...
			rfvlsiHFSS_Create_xfm_lead rfvlsi_newOriginX(rfvlsi_pcellOffsetX0, rfvlsi_pcellOffsetY0, rfvlsi_pcellOffsetORIENT, (((((-OD))/(2)+((NT-1))*(P))+W)), (((-W))/(2)), rfvlsi_ORIENT_R0), _
				rfvlsi_newOriginY(rfvlsi_pcellOffsetX0, rfvlsi_pcellOffsetY0, rfvlsi_pcellOffsetORIENT, (((((-OD))/(2)+((NT-1))*(P))+W)), (((-W))/(2)-OPENCT), rfvlsi_ORIENT_R0), _	
				rfvlsi_newORIENT(rfvlsi_pcellOffsetORIENT, rfvlsi_ORIENT_R0), _
				(((LEAD+OD)-(NT)*(P))+S),W,1.0,"CTn","dummy1","7","7",DUMMYL,"drawing",dummy
...
End Sub
'Invoke TopCell
													   'OD , W , OPENING , OPENCT, LEAD , S , TOP_ME , NT , L1A , L1B , BTM_ME , dummy , DUMMYL , NT_N )
rfvlsiHFSS_Create_ind_sym_cct 0,  0,  rfvlsi_ORIENT_R0,  OD_VAL,  W_VAL,  10, 6, 20 , S_VAL,   9 , 2 , "1n" , "1n" , 9 , false , "RFVLSI" , false 
