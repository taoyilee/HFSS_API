...
oProject.SaveAs "G:\HFSS_SIMULATIONS\T65_SYM_2T\SYM-D80W4S3.hfss", true
...
oProject.ChangeProperty Array("NAME:AllTabs", Array("NAME:ProjectVariableTab", Array("NAME:PropServers",  _
  "ProjectVariables"), Array("NAME:ChangedProps", Array("NAME:$M9_S", "Value:=", "3um"))))
oProject.ChangeProperty Array("NAME:AllTabs", Array("NAME:ProjectVariableTab", Array("NAME:PropServers",  _
...
rfvlsiHFSS_Create_ind_sym 0,  0,  rfvlsi_ORIENT_R0,  80,  4,  10, 20 , 3,   9, 2 , "1n" , 9 , false , "RFVLSI" , false 
