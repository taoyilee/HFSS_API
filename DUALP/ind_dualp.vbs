...
oProject.InsertDesign "HFSS","ind_dualp", "DrivenModal", ""
Set oDesign = oProject.SetActiveDesign("ind_dualp")
Set oEditor = oDesign.SetActiveEditor("3D Modeler")

oProject.SaveAs "C:\Users\michaelgod\Dropbox\GIT\HFSS_API\DUALP\output\ind_dualp_O<OD>W<W>S<S>.hfss", true
...
Sub rfvlsiHFSS_Create_base_xfm_cross(rfvlsi_pcellOffsetX0, rfvlsi_pcellOffsetY0, rfvlsi_pcellOffsetORIENT, ByVal WI , ByVal WO , ByVal S , ByVal TOP_ME , ByVal BTM_ME , ByVal dummy , ByVal viat , ByVal viad , ByVal top )
	...
	C2 = ceiltogrid((C)/(Sqr(2)))
	OOCH = (((WO)+(S))+((WI)/(2)))-(C2)

	If ((((2)*(S))+(WI))<=((2.0)*(Sqr(2.0)))) Then
		OOCHD = ceiltogrid(((2.01)*(Sqr(2.0)))-(WI))
	Else
		OOCHD = 0.0
	End If
...
Sub rfvlsiHFSS_Create_base_ind_hud_cross(rfvlsi_pcellOffsetX0, rfvlsi_pcellOffsetY0, rfvlsi_pcellOffsetORIENT, ByVal OD , ByVal W , ByVal S , ByVal OPENING , ByVal TOP_ME , ByVal BTM_ME , ByVal under , ByVal dummy , ByVal DUMMYL )
	...
	rfvlsiHFSS_Create_base_oct rfvlsi_newOriginX(rfvlsi_pcellOffsetX0, rfvlsi_pcellOffsetY0, rfvlsi_pcellOffsetORIENT, 0, 0, rfvlsi_ORIENT_R0), _
		rfvlsi_newOriginY(rfvlsi_pcellOffsetX0, rfvlsi_pcellOffsetY0, rfvlsi_pcellOffsetORIENT, 0, 0, rfvlsi_ORIENT_R0), _	
		rfvlsi_newORIENT(rfvlsi_pcellOffsetORIENT, rfvlsi_ORIENT_R0),_
		OD, W, ((OOCH)+(roundtogrid(((2)*(Sqr(2.0)))-(S))))+(0.01), OPENING, 9
...
Sub rfvlsiHFSS_Create_ind_sym(rfvlsi_pcellOffsetX0, rfvlsi_pcellOffsetY0, rfvlsi_pcellOffsetORIENT, ByVal OD , ByVal W , ByVal OPENING , ByVal LEAD , ByVal S , ByVal NT , ByVal strName , ByVal NT_N , ByVal dummy )
	...
	rfvlsiHFSS_Create_base_em_gr rfvlsi_newOriginX(rfvlsi_pcellOffsetX0, rfvlsi_pcellOffsetY0, rfvlsi_pcellOffsetORIENT, 0, 0, rfvlsi_ORIENT_R0), _
		rfvlsi_newOriginY(rfvlsi_pcellOffsetX0, rfvlsi_pcellOffsetY0, rfvlsi_pcellOffsetORIENT, 0, 0, rfvlsi_ORIENT_R0), _	
		rfvlsi_newORIENT(rfvlsi_pcellOffsetORIENT, rfvlsi_ORIENT_R0),_
		((OD)+(LEAD)), (((OD)+((2)*(LEAD)))-(4)), 2.0, 10.0, 1
	'Adding a vertical lumped port.
	CVport "P1",((OD)/(2))+(LEAD),OPENING,((OD)/(2))+(LEAD),(OPENING)+(W),((OPENING)+(W))-(OPENING),"X",0,8,1
	'Adding a vertical lumped port.
	CVport "N1",((OD)/(2))+(LEAD),(-(OPENING)),((OD)/(2))+(LEAD),((-(OPENING)))-(W),(((-(OPENING)))-(W))-((-(OPENING))),"X",0,8,1
End Sub
' This source code is generated by NCTU RFVLSI Lab SKILL -> HFSS VBscript translator.
' This SKILL/HFSS VBsciprt Translator is a intellectual property of RFVLSI Lab, NCTU, Taiwan
' All rights reserved. 2012-2013. Confidential, and intended for internal use only. 
	...
	If ((S)<=((2.0)*(Sqr(2)))) Then
		CMetalPolygon ((MET)-(1)), _
			...
			Array(_
				...
				rfvlsi_newOriginX(rfvlsi_PCellOffsetX0, rfvlsi_PCellOffsetY0, rfvlsi_PCellOffsetORIENT, 0 , (-(((OOCH)+(ceiltogrid(((2.01)*(Sqr(2.0)))-(S)))))) , rfvlsi_ORIENT_R0),_ 
				rfvlsi_newOriginX(rfvlsi_PCellOffsetX0, rfvlsi_PCellOffsetY0, rfvlsi_PCellOffsetORIENT, W , (-(((OOCH)+(ceiltogrid(((2.01)*(Sqr(2.0)))-(S)))))) , rfvlsi_ORIENT_R0),_ 
				...
				rfvlsi_newOriginX(rfvlsi_PCellOffsetX0, rfvlsi_PCellOffsetY0, rfvlsi_PCellOffsetORIENT, OO , ((OOCH)+(ceiltogrid(((2.01)*(Sqr(2.0)))-(S)))) , rfvlsi_ORIENT_R0),_ 
				rfvlsi_newOriginX(rfvlsi_PCellOffsetX0, rfvlsi_PCellOffsetY0, rfvlsi_PCellOffsetORIENT, (OO)-(W) , ((OOCH)+(ceiltogrid(((2.01)*(Sqr(2.0)))-(S)))) , rfvlsi_ORIENT_R0),_ 
			...
			Array(_
				...
				rfvlsi_newOriginY(rfvlsi_PCellOffsetX0, rfvlsi_PCellOffsetY0, rfvlsi_PCellOffsetORIENT, 0 , (-(((OOCH)+(ceiltogrid(((2.01)*(Sqr(2.0)))-(S)))))) , rfvlsi_ORIENT_R0),_ 
				rfvlsi_newOriginY(rfvlsi_PCellOffsetX0, rfvlsi_PCellOffsetY0, rfvlsi_PCellOffsetORIENT, W , (-(((OOCH)+(ceiltogrid(((2.01)*(Sqr(2.0)))-(S)))))) , rfvlsi_ORIENT_R0),_ 
				...
				rfvlsi_newOriginY(rfvlsi_PCellOffsetX0, rfvlsi_PCellOffsetY0, rfvlsi_PCellOffsetORIENT, OO , ((OOCH)+(ceiltogrid(((2.01)*(Sqr(2.0)))-(S)))) , rfvlsi_ORIENT_R0),_ 
				rfvlsi_newOriginY(rfvlsi_PCellOffsetX0, rfvlsi_PCellOffsetY0, rfvlsi_PCellOffsetORIENT, (OO)-(W) , ((OOCH)+(ceiltogrid(((2.01)*(Sqr(2.0)))-(S)))) , rfvlsi_ORIENT_R0),_ 
...
Sub rfvlsiHFSS_Create_ind_dual(rfvlsi_pcellOffsetX0, rfvlsi_pcellOffsetY0, rfvlsi_pcellOffsetORIENT, ByVal OD , ByVal W , ByVal OPENING , ByVal OP2 , ByVal LEAD , ByVal S , ByVal NT , ByVal strName , ByVal PIN_TXT , ByVal NT_N )
	P = (W)+(S)
	DUMMYL = "RFVLSI"
	' dbCreateLabel is skipped in translation output, and not processed at all.
	' dbCreateLabel is skipped in translation output, and not processed at all.
	...
	' No output for: m_vias=dbOpenCellViewByType(pcCellView~>lib"vias""layout"), but is internally processed.
	' No output for: m_lead=dbOpenCellViewByType(pcCellView~>lib"base_lead""layout"), but is internally processed.
	rfvlsiHFSS_Create_ind_sym rfvlsi_newOriginX(rfvlsi_pcellOffsetX0, rfvlsi_pcellOffsetY0, rfvlsi_pcellOffsetORIENT, (((((-(OD)))/(2))-(OP2))-(OPENING)), 0, rfvlsi_ORIENT_R0), _
		rfvlsi_newOriginY(rfvlsi_pcellOffsetX0, rfvlsi_pcellOffsetY0, rfvlsi_pcellOffsetORIENT, (((((-(OD)))/(2))-(OP2))-(OPENING)), 0, rfvlsi_ORIENT_R0), _	
		rfvlsi_newORIENT(rfvlsi_pcellOffsetORIENT, rfvlsi_ORIENT_R0),_
		OD, W, 4.0, OP2, S, NT, "ind_sym", NT_N, False
	rfvlsiHFSS_Create_ind_sym rfvlsi_newOriginX(rfvlsi_pcellOffsetX0, rfvlsi_pcellOffsetY0, rfvlsi_pcellOffsetORIENT, ((((OD)/(2))+(OP2))+(OPENING)), 0, rfvlsi_ORIENT_MY), _
		rfvlsi_newOriginY(rfvlsi_pcellOffsetX0, rfvlsi_pcellOffsetY0, rfvlsi_pcellOffsetORIENT, ((((OD)/(2))+(OP2))+(OPENING)), 0, rfvlsi_ORIENT_MY), _	
		rfvlsi_newORIENT(rfvlsi_pcellOffsetORIENT, rfvlsi_ORIENT_MY),_
		OD, W, 4.0, OP2, S, NT, "ind_sym", NT_N, False
	CMetalRect rfvlsi_newORIENT(rfvlsi_PCellOffsetORIENT, rfvlsi_ORIENT_R0), _
		(8), _ 
		rfvlsi_newOriginX(rfvlsi_PCellOffsetX0, rfvlsi_PCellOffsetY0, rfvlsi_PCellOffsetORIENT, (-(OPENING)), 4.0, rfvlsi_ORIENT_R0), _ 
		rfvlsi_newOriginY(rfvlsi_PCellOffsetX0, rfvlsi_PCellOffsetY0, rfvlsi_PCellOffsetORIENT, (-(OPENING)), 4.0, rfvlsi_ORIENT_R0), _ 
		(OPENING)-((-(OPENING))), ((4.0)+(W))-(4.0), 1, 1, 1.0, 1.0	
		

	' Not using MetalVec/ViaVec, thus ignored in translation
	' Not using MetalVec/ViaVec, thus ignored in translation
	rfvlsiHFSS_Create_base_lead rfvlsi_newOriginX(rfvlsi_pcellOffsetX0, rfvlsi_pcellOffsetY0, rfvlsi_pcellOffsetORIENT, (W)/(2), (4.0)+(W), rfvlsi_ORIENT_R90), _
		rfvlsi_newOriginY(rfvlsi_pcellOffsetX0, rfvlsi_pcellOffsetY0, rfvlsi_pcellOffsetORIENT, (W)/(2), (4.0)+(W), rfvlsi_ORIENT_R90), _	
		rfvlsi_newORIENT(rfvlsi_pcellOffsetORIENT, rfvlsi_ORIENT_R90),_
		((((LEAD)+((OD)/(2)))-(4.0))-(W)), W, 1.0, PIN_TXT, "dummy1", "9", "9", "RFVLSI", "drawing", True
	rfvlsiHFSS_Create_base_em_gr rfvlsi_newOriginX(rfvlsi_pcellOffsetX0, rfvlsi_pcellOffsetY0, rfvlsi_pcellOffsetORIENT, 0, 0, rfvlsi_ORIENT_R0), _
		rfvlsi_newOriginY(rfvlsi_pcellOffsetX0, rfvlsi_pcellOffsetY0, rfvlsi_pcellOffsetORIENT, 0, 0, rfvlsi_ORIENT_R0), _	
		rfvlsi_newORIENT(rfvlsi_pcellOffsetORIENT, rfvlsi_ORIENT_R0),_
		(((((2)*(OD))+((2)*(LEAD)))+((2)*(OP2)))+((2)*(OPENING))), (((OD)+((2)*(LEAD)))-(4)), 2.0, 10.0, 2
...
Sub rfvlsiHFSS_Create_ind_dualp(rfvlsi_pcellOffsetX0, rfvlsi_pcellOffsetY0, rfvlsi_pcellOffsetORIENT, ByVal OD , ByVal W , ByVal OPENING , ByVal OP2 , ByVal LEAD , ByVal S , ByVal NT , ByVal strName , ByVal NT_N )
	DUMMYL = "RFVLSI"
	' dbCreateLabel is skipped in translation output, and not processed at all.
	' No output for: m_ind_dual=dbOpenCellViewByType(pcCellView~>lib"ind_dual""layout"), but is internally processed.
	' No output for: m_vias=dbOpenCellViewByType(pcCellView~>lib"vias""layout"), but is internally processed.
	' No output for: m_lead_pair=dbOpenCellViewByType(pcCellView~>lib"base_lead_pair""layout"), but is internally processed.
	' No output for: m_lead=dbOpenCellViewByType(pcCellView~>lib"base_lead""layout"), but is internally processed.
	rfvlsiHFSS_Create_ind_dual rfvlsi_newOriginX(rfvlsi_pcellOffsetX0, rfvlsi_pcellOffsetY0, rfvlsi_pcellOffsetORIENT, 0, 0, rfvlsi_ORIENT_R0), _
		rfvlsi_newOriginY(rfvlsi_pcellOffsetX0, rfvlsi_pcellOffsetY0, rfvlsi_pcellOffsetORIENT, 0, 0, rfvlsi_ORIENT_R0), _	
		rfvlsi_newORIENT(rfvlsi_pcellOffsetORIENT, rfvlsi_ORIENT_R0),_
		OD, W, OPENING, OP2, LEAD, S, NT, strName, "CT", NT_N
	rfvlsiHFSS_Create_base_lead_pair rfvlsi_newOriginX(rfvlsi_pcellOffsetX0, rfvlsi_pcellOffsetY0, rfvlsi_pcellOffsetORIENT, 0, ((-(4.0)))-(W), rfvlsi_ORIENT_MYR90), _
		rfvlsi_newOriginY(rfvlsi_pcellOffsetX0, rfvlsi_pcellOffsetY0, rfvlsi_pcellOffsetORIENT, 0, ((-(4.0)))-(W), rfvlsi_ORIENT_MYR90), _	
		rfvlsi_newORIENT(rfvlsi_pcellOffsetORIENT, rfvlsi_ORIENT_MYR90),_
		W, OPENING, ((((LEAD)+((OD)/(2)))-(4.0))-(W)), "9", "9", True, "P1", "N1"
	boundary_ext = 30
	'Adding a vertical lumped port.
	CVport "CT",(((-(W)))/(2)),(((OD)/(2))+(LEAD)),(W)/(2),(((OD)/(2))+(LEAD)),((W)/(2))-((((-(W)))/(2))),"Y",0,8,2
	'Adding a vertical lumped port.
	CVport "P1",(((-(OPENING)))-(W)),((((-(OD)))/(2))-(LEAD)),((-(OPENING))),((((-(OD)))/(2))-(LEAD)),(((-(OPENING))))-((((-(OPENING)))-(W))),"Y",0,8,2
	'Adding a vertical lumped port.
	CVport "N1",OPENING,((((-(OD)))/(2))-(LEAD)),((OPENING)+(W)),((((-(OD)))/(2))-(LEAD)),(((OPENING)+(W)))-(OPENING),"Y",0,8,2
End Sub
'Generating topcell
rfvlsiHFSS_Create_ind_dualp 0.0, 0.0, rfvlsi_ORIENT_R0, <OD>, <W>, 5.0, 5.0, 10.0, <S>, 2, "ind_dualp", False 
