function serial = hfss_xfm_halfudN(fid,X , Y, Z, W, R_OP,L_OP, OD,Thickness, serial)
    hfssUDP(fid, 'xfm_half', ['L' num2str(serial)], 10, {'Xpos', 'Ypos',  'Zpos','OD','W','L_OP', 'R_OP', 'Thickness', 'maskGrid', 'DIV'},...
            {X,Y,Z,OD,W,L_OP,R_OP,Thickness, '0.005', '$DIV'}, hfssgetmaterial('T40_ME0d021'),{'255','0','0'});
