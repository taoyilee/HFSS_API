function [tmpDataFiles replot sn] = t65cpw_wh(tmpScriptFile, fid, M9_W, M9_S,M9_L, GND_H, GND_F,outdir)
    ...
    if(~exist(tmpDataFiles,'file'))
        ...
        if(~exist(projectname,'file'))         
            ...
            hfssEditSolution(fid, setup_name, '-1');
