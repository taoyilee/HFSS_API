...
try
	...
	OD = 60:5:120; M11_W = 2:1:8;  M11_S = 1:3; NT =1:3;
    dlmwrite('G:\HFSS_SIMULATIONS\t40_ind\summary.csv', ...
        ...
        for j=1:length(M11_W)
            for k=1:length(M11_S)
                for l=1:length(NT)
                    ...
                    [tmpDataFiles replot] = t40ind_wh(tmpScriptFile, fid, OD(i), M11_W(j), M11_S(k), NT(l));    
